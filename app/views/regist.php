...
if (!empty($_POST['login']) && !empty($_POST['pass'])) {
    ...
    if (!empty($user)) {
        $_SESSION['warning'] = '<div class="alert alert-warning row col-sm-4 mx-auto" role="alert">User with this login is already registered. Try signIn!</div>';
        ...
        $_SESSION['warning'] = '<div class="alert alert-success row col-sm-4 mx-auto" role="alert">You have been successfully registered!</div>';
